    ...
    $.ajax({
        ...
        success : function(result){
            ...
            for(var i=0;i<result.length;i++) {
                ...
                if(result[0].count>=firstpageNum){
                    var checkpage = 0;
                    if(firstpageNum <=lastPageNum){


                        var sp1 = $("<span onclick='list("+(firstpageNum-1)+")'><</span>");
                        var pagenum = $("<a id='"+(firstpageNum)+"' href='#' onclick='list("+firstpageNum+")'>"+firstpageNum+"</a>");
 ...
 /*               if(result[0].pageCal==0){
                ...
                if(result[0].count>=firstpageNum){
                    ...
                    if(firstpageNum <=lastPageNum){
                        ...
                        var sp1 = $("<span onclick='list("+(firstpageNum-1)+")'><</span>");
                        pagenum = $("<a id='"+(firstpageNum)+"' href='#' onclick='list("+firstpageNum+")'>"+firstpageNum+"</a>");
            ...
            success : function(result){
                ...
                for(var i=0;i<result.length;i++) {
                    ...
                    if(result[0].count>=firstpageNum){
                        var checkpage = 0;
                        if(firstpageNum <=lastPageNum){
                            var sp1 = $("<span onclick='list("+(firstpageNum-1)+","+'"'+result[0].keyword+'"'+")'><</span>");
                            var pagenum = $("<a id='"+(firstpageNum)+"' href='#' onclick='searchBook1("+firstpageNum+","+'"'+result[0].keyword+'"'+")'>"+firstpageNum+"</a>");
                            ...
                            if(firstpageNum==lastPageNum){
                                var sp = $("<span onclick='searchBook1("+(firstpageNum+1)+","+'"'+result[0].keyword+'"'+")'>></span>");
                                $(".paging").append(sp);
                            }
...
//검색어와 page번호가 함께 넘어가면
function searchBook1(page,keyword){
